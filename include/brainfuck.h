...
#define BRAINFUCK_TOKEN_PLUS 'o'
#define BRAINFUCK_TOKEN_MINUS 'i'
#define BRAINFUCK_TOKEN_PREVIOUS 'a'
#define BRAINFUCK_TOKEN_NEXT 'e'
#define BRAINFUCK_TOKEN_OUTPUT 'u'
#define BRAINFUCK_TOKEN_INPUT 'y'
