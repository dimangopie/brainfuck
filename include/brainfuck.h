...
#define SUB_BRAINFUCK_TOKEN_PLUS 'o'
#define CAPITAL_SUB_BRAINFUCK_TOKEN_PLUS 'O'
#define SUB_BRAINFUCK_TOKEN_MINUS 'i'
#define CAPITAL_SUB_BRAINFUCK_TOKEN_MINUS 'I'
#define SUB_BRAINFUCK_TOKEN_PREVIOUS 'a'
#define CAPITAL_SUB_BRAINFUCK_TOKEN_PREVIOUS 'A'
#define SUB_BRAINFUCK_TOKEN_NEXT 'e'
#define CAPITAL_SUB_BRAINFUCK_TOKEN_NEXT 'E'
#define SUB_BRAINFUCK_TOKEN_OUTPUT 'u'
#define CAPITAL_SUB_BRAINFUCK_TOKEN_OUTPUT 'U'
#define SUB_BRAINFUCK_TOKEN_INPUT 'y'
#define CAPITAL_SUB_BRAINFUCK_TOKEN_INPUT 'Y'
